...
class _OnBoardingPageState extends State<OnBoardingPage> {
  ...
  void _showErrorDialog(String message, AppLocalizations local) {
    if (!mounted) return;
    showDialog(
      context: context,
  ...
  Future<void> handleAuth({required bool isSignUp, required AppLocalizations local}) async {
    showDialog(
      context: context,
    ...
    try {
      ...
      if (!mounted) return;
      Navigator.pop(context);
      _showErrorDialog(_firebaseErrorMessage(e.code), local);
    }
  }
                    ...
                    Submitbutton(
                      ...
                      onPressed: () {
                        ...
                        if (form != null && form.validate()) {
                          form.save();
                          handleAuth(isSignUp: onBoardingState.switchSignUp, local: local);
                        }
                      },
                      width: size.width,
                      widget: Text(
